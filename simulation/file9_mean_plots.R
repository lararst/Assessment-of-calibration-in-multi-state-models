...
combine_mean_plotdata <- function(scen, n.cohort, n.pctls, type, sens = FALSE){
  ...
  ### Load data
  if (sens == FALSE){
    load(paste("/small_sim_",scen,"/mean_",scen,"_", n.cohort, "/small_sample_mean_analysis_", scen, "_n", n.cohort, "_npctls", n.pctls, ".RData", sep = ""))
  } else if (sens == TRUE){
    load(paste("/small_sim_",scen,"/sens_mean_",scen,"_", n.cohort, "/small_sample_mean_analysis_sens_", scen, "_n", n.cohort, ".RData", sep = ""))
  }
